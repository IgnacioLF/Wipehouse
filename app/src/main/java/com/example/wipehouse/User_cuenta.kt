...
class User_cuenta : Fragment() {
    ...
    override fun onCreateView(
        ...
        var  root = inflater.inflate(R.layout.fragment_user_cuenta, container, false)
        editTextTextNombre = root.findViewById(R.id.editTextTextNombre)
        editTextTextNombre.setText("esto es una prueba")
        return root
    }
